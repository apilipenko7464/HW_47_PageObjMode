...
public class SignUpPage {
    ...
    public String verify_imageLINK( String id_link) {
        ...
        System.out.println("New TITLE IS: " + title_link_actual );
        driver.close();
    ...
    public String getFirstName_emptyField(){
        driver.findElement(By.id("id_fname")).clear();
        driver.findElement(By.id("id_submit_button")).click();
        return getErrorMassage();}

    public String getLastName_emptyField(){
        InputFirstName();
        driver.findElement(By.id("id_lname")).clear();
        driver.findElement(By.id("id_submit_button")).click();
        return getErrorMassage();}

    public String getEmailAddress_emptyField(){
        InputFirstName();
        InputLastName();
    ...
    public String getPhoneNumber_emptyField(){
        InputFirstName();
        InputLastName();
        InputEmailAddress();
    ...
    public String getFirstName_invalidImput(String ivalid_imput){
        driver.findElement(By.id("id_fname")).clear();
        driver.findElement(By.id("id_fname")).sendKeys(ivalid_imput);
        driver.findElement(By.id("id_submit_button")).click();
        return getErrorMassage();}

    public String getLastName_invalidImput(String ivalid_imput){
        InputFirstName();
        driver.findElement(By.id("id_lname")).clear();
        driver.findElement(By.id("id_lname")).sendKeys(ivalid_imput);
        driver.findElement(By.id("id_submit_button")).click();
        return getErrorMassage();}

    public String getEmail_invalidImput(String ivalid_imput){
        InputFirstName();
        InputLastName();
        driver.findElement(By.id("id_email")).clear();
        driver.findElement(By.id("id_email")).sendKeys(ivalid_imput);
        driver.findElement(By.id("id_submit_button")).click();
        return getErrorMassage();}

    public String getPhone_invalidImput(String ivalid_imput){
        InputFirstName();
        InputLastName();
        InputEmailAddress();
        driver.findElement(By.id("id_phone")).clear();
        driver.findElement(By.id("id_phone")).sendKeys(ivalid_imput);
        driver.findElement(By.id("id_submit_button")).click();
    ...
    public void InputPhoneNumber() {
        driver.findElement(By.id("id_email")).clear();
        driver.findElement(By.id("id_email")).sendKeys(phone);
    }
    ...
    public String  getErrorMassage() {
        return driver.findElement(By.id("ErrorLine")).getText();
    }
